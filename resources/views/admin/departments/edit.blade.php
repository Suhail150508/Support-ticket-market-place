...
<div class="page-header mb-4">
    <div>
        <h1 class="mb-2"><i class="fas fa-edit me-2"></i>{{__('Edit Department')}}</h1>
        <p class="mb-0 opacity-75">{{__('Update support department details')}}</p>
    </div>
</div>
        ...
        <form action="{{ route('admin.departments.update', $department->id) }}" method="POST">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-2"></i>{{__('Update Department')}}
                </button>
            </div>
        </form>
    </div>
